...
class TorqueJointSpaceControllerSyStartpoint : public controller_interface::MultiInterfaceController<
 ...
 private: 
  ...
  double move_z_data[1000];
  double move_x_data[1000];
  double move_y_data[1000];
  double move_angle_data[1000];
