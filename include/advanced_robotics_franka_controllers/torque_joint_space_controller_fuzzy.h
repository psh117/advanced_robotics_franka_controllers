...
class TorqueJointSpaceControllerFuzzy : public controller_interface::MultiInterfaceController<
 ...
 private: 
  ...
  double fuzzy_output_cur_;
  double fuzzy_output_prev_;
  double fuzzy_output_;
  double crisp_output_cur_;
  double crisp_output_prev_;
  double crisp_output_;
  int count_;
  int count_2_;
